...
import type { ScenarioInputs, ScenarioResult, SourcedValue } from './types'
...
export function deriveScenario(inputs: ScenarioInputs, decisionPolicy?: SourcedValue): ScenarioResult {
  return adaptEstimateResponse(createMockEstimate(toEstimateRequest(inputs), inputs, decisionPolicy), inputs, decisionPolicy)
}
